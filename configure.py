...
parser.add_option("--plug-in folders", action="store", type="string", dest="plug-in folders", default="", help="defines a directory with plug-in folders")
...
parser.add_option("--db-pass", action="store", type="string", dest="db-pass", default="", help="defines the sql db-pass wich will be used")
