...
if base.is_exist(sys.argv[1] + '/server/DocService/package.json'):
  ...
  base.replaceInFileRE("/etc/supervisor/conf.d/ds-docservice.conf", "command=.*", "command=/var/www/onlyoffice/documentserver/server/DocService/docservice")
  base.replaceInFileRE("/etc/supervisor/conf.d/ds-converter.conf", "command=.*", "command=/var/www/onlyoffice/documentserver/server/FileConverter/converter")
