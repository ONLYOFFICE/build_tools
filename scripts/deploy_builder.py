...
def make():
  ...
  for native_platform in platforms:
    ...
    # x2t
    base.copy_lib(core_dir + "/build/lib/" + platform, root_dir, "kernel")
    base.copy_lib(core_dir + "/build/lib/" + platform, root_dir, "UnicodeConverter")
    base.copy_lib(core_dir + "/build/lib/" + platform, root_dir, "graphics")
    base.copy_lib(core_dir + "/build/lib/" + platform, root_dir, "PdfWriter")
    base.copy_lib(core_dir + "/build/lib/" + platform, root_dir, "PdfReader")
    base.copy_lib(core_dir + "/build/lib/" + platform, root_dir, "DjVuFile")
    base.copy_lib(core_dir + "/build/lib/" + platform, root_dir, "XpsFile")
    base.copy_lib(core_dir + "/build/lib/" + platform, root_dir, "HtmlFile")
    base.copy_lib(core_dir + "/build/lib/" + platform, root_dir, "HtmlRenderer")

    if ("ios" == platform):
      base.copy_lib(core_dir + "/build/lib/" + platform, root_dir, "x2t")
    else:
      base.copy_exe(core_dir + "/build/bin/" + platform, root_dir, "x2t")
    ...
    # doctrenderer
    if isWindowsXP:
      base.copy_lib(core_dir + "/build/lib/" + platform + "/xp", root_dir, "doctrenderer")
      base.copy_files(core_dir + "/Common/3dParty/v8/v8_xp/" + platform + "/release/icudt*.dll", root_dir + "/")
    else:
      base.copy_lib(core_dir + "/build/lib/" + platform, root_dir, "doctrenderer")
      if (0 == platform.find("win")):
    ...
    # app
    base.copy_exe(core_dir + "/build/bin/" + platform, root_dir, "docbuilder")
    ...
    if (False == isWindowsXP) and (0 != platform.find("mac")) and (0 != platform.find("ios")):
      base.copy_exe(core_dir + "/build/lib/" + platform, root_dir + "/HtmlFileInternal", "HtmlFileInternal")
